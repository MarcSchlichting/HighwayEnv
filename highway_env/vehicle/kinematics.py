...
class Vehicle(RoadObject):
    ...
    PERTURBATION_MEAN = 5
    """Mean of acceleration perturbation range."""
    PERTURBATION_RANGE = 5
    """Radius of acceleration perturbation range."""
    ...
    def clip_actions(self) -> None:
        ...
        if self.speed > self.MAX_SPEED:
            ...
            if np.random.rand() < 0.5:
                self.action["acceleration"] -= np.random.uniform(self.PERTURBATION_MEAN - self.PERTURBATION_RANGE, 
                                                                 self.PERTURBATION_MEAN + self.PERTURBATION_RANGE)
